# dash-react-graph-vis

A plot.ly Dash component using react-graph-vis by @crubier which uses vis.js to draw force-directed graphs.
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> dash-react-graph-vis -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import dash-react-graph-vis to your layout, then run it:
